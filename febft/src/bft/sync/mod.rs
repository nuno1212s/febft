...
use crate::bft::communication::message::{ConsensusMessage, ConsensusMessageKind, ForwardedRequestsMessage, FwdConsensusMessage, Header, RequestMessage, StoredMessage, SystemMessage, ViewChangeMessage, ViewChangeMessageKind, WireMessage};
use crate::bft::communication::{Node, NodeId, serialize};
