...
use febft_messages::messages::{ForwardedRequestsMessage, SystemMessage};
...
impl<S: Service + 'static> FollowersFollowing<S> {
    ...
    fn handle_preprepare_msg_rcvd(
        ...
        todo!();
        /*
        let message = SystemMessage::ForwardedRequests(ForwardedRequestsMessage::new(header, pre_prepare));
