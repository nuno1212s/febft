...
pub const REQUEST_SEND_TIME: &str = "REQUEST_SEND_TIME";
pub const REQUEST_SEND_TIME_ID: usize = 407;

pub fn metrics() -> Vec<MetricRegistry> {
    vec![
        (COMM_RQS_RECVD_ID, COMM_RQS_RECVD.to_string(), MetricKind::Counter).into(),
        (COMM_RQS_SENT_ID, COMM_RQS_SENT.to_string(), MetricKind::Counter).into(),
        ...
        (REPLICA_RQ_PASSING_TIME_ID, REPLICA_RQ_PASSING_TIME.to_string(), MetricKind::Duration).into(),
    ]
}