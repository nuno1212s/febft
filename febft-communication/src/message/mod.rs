...
pub type StoredSerializedNetworkMessage<T> = SerializedMessage<NetworkMessage<T>>;
...
impl<M: Orderable> Orderable for StoredMessage<M> {
...
///
/// The messages that will be sent over the network in this protocol.
///
#[derive(Clone, Debug)]
...
///
#[cfg_attr(feature = "serialize_serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature = "serialize_bincode", derive(Decode, Encode))]
#[derive(Clone)]
