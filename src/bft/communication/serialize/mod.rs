...
pub trait SharedData: Send {
    ...
    fn serialize_request<W>(w: W, request: &Self::Request) where W: Write;
    ...
    fn serialize_reply<W>(w: W, reply: &Self::Reply) where W: Write;
...
pub trait DigestData: SharedData {
    ...
    fn serialize_digest<W: Write + AsRef<[u8]>> (
        ...
        base_serialization::serialize_message::<W, Self>(&mut w, message)?;
    ...
    fn deserialize_message<R: Read>(r: R) -> Result<SystemMessage<Self::State, Self::Request, Self::Reply>> {
        base_serialization::deserialize_message::<R, Self>(r)
    }
}
...
pub trait Persister: SharedData {
    ...
    fn serialize_consensus_message<W: Write> (
        ...
        base_serialization::serialize_consensus::<W, Self>(&mut w, message)
    }

    fn deserialize_consensus_message<R: Read> (
        r: R
    ) -> Result<ConsensusMessage< Self::Request>> {
        base_serialization::deserialize_consensus::<R, Self>(r)
    }
